...
📂 مشاريع مميزة من سجل النشاط الأخير (Recent Highlights)

إليك نظرة على بعض المستودعات التي عملت عليها مؤخراً، والتي تبرز تنوع مهاراتي التقنية:

AbdalrhmanAbdoAlhade/zh-coding_ac_go

التقنية: Go

القيمة: يوضح الخبرة في بناء النظم الخلفية باستخدام لغة Go ذات الأداء العالي.

AbdalrhmanAbdoAlhade/Student-Carbon-Footprint

التقنية: TypeScript

القيمة: يبرز قدرتي على العمل في بيئات التطوير الشامل (Full-stack) أو تطوير الخدمات التي تتطلب TypeScript/JavaScript.

AbdalrhmanAbdoAlhade/b2b & AbdalrhmanAbdoAlhade/fas

التقنية: PHP

القيمة: دليل على العمل المستمر والخبرة العملية في مشاريع PHP و Laravel التجارية.

📊 إحصاءات GitHub الرئيسية (أرقام ثابتة)

تعكس هذه الأرقام نشاطي الكلي والتزامي بالكود والتطوير، مع إدراج المشاريع الخاصة:

المقياس

القيمة التقريبية

إجمالي المستودعات (Total Repos)

47

الالتزامات في الشهر الأخير

36+

اللغات الأساسية للمشاريع الخاصة

Go, PHP, TypeScript

ملاحظة: هذه الأرقام تم تحديثها بناءً على بياناتك لتظهر نشاطك الكلي.
...
<details>
<summary>عرض 65 موقعاً إضافياً قيد التشغيل 🔽</summary>
